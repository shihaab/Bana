    ...
    <body class="antialiased">
        ...
        <div id="content">
            <div class="room">
                ...
                <button class="light-switch" id="1" onclick="doSwitch('http://192.168.178.60:2390/led_1?value=', this.id)"></button>
            </div>
            <div class="room">
                <h1 class="room-name">Bedroom</h1>
                <p class="room-light-status">All lights off</p>
                <button class="light-switch" id="2" onclick="doSwitch('http://192.168.178.60:2390/led_2?value=', this.id)"></button>
            </div>
        </div>
        <div id="menu">
        ...
        <!-- <script type="module" src="{{ asset('js/app.js') }}" async defer></script> -->
        ...
        <script>
            ...
            function getStatuses() {
                let items = { 1: "http://192.168.178.60:2390/led_1_status", 2: "http://192.168.178.60:2390/led_2_status"};
                ...
                Object.keys(items).forEach(function (key) {
                    ...
                    axios.get(items[key], {
                        ...
                        console.log('led state: '+res.data.state);
